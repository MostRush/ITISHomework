...
<br>(Дополнительно)
- ✖️ Обобщить это до игры в крестики – нолики на 2 игроков(с рисованием доски в виде крестиков и ноликов и вводе по цифрам).
...
### 36. ❌ FightingGame
Задача: Реализовать модель игры – игроки последовательно друг другу наносят удары силой от 1 до 9, при этом у того, кого ударили, из очков здоровья (health points, hp) отнимается сила удара. Игра заканчивается, когда hp одного из игроков стало <= 0 В задаче должны быть классы Игрок и Игра, в которой весь процесс происходит. У каждого игрока есть имя и здоровье. Сила удара каждого игрока на каждом шаге вводится из консоли. Процесс игры должен принадлежать объекту класса Игра.
<br>(Дополнительно):
- ❌ Cпецифическая способность
- ❌ Берем задачу с игрой – делаем 2го игрока ботом с помощью наследования.
- ❌ Сделать класс игрок абстрактным, переместить методы относящиеся к игроку из класса игра в класс наследник. Сделать ввод имени и сохранение статистики в файл.

### 37. ❌ NamespaceConnect
Задача: Найти как и попробовать подключить один namespace  к другому (т.е. погуглить)

### 38. ❌ NAngleFigureClass
...
### 39. ❌ ClassMatrix3x3
Задача: Создать класс Matrix3x3 - двумерная матрица из вещественных чисел. Аргументы -
